...
( function() {
	...
	var JB_Table = function(tab) {
		...
		var initTableHead = function(t,nr) {
			...
			if(window.addEventListener) t.addEventListener("click",function() { dieses.sort(nr); },false);
			else if(window.attachEvent) t.attachEvent("onclick",function() { dieses.sort(nr); }); 
